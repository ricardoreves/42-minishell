...
#    Updated: 2022/02/28 17:54:36 by rpinto-r         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC        = ./incs
SRC_DIR    = ./srcs
SRC_NAME   = main.c builtin.c command.c error.c signal.c parsing.c parsing_sanitize.c parsing_utils.c redirect.c free.c
