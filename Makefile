...
#    Updated: 2022/02/28 17:18:25 by rpinto-r         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC        = ./incs
SRC_DIR    = ./srcs
SRC_NAME   = main.c builtin.c command.c error.c signal.c varenv.c parsing.c parsing_sanatize.c redirect.c free.c
