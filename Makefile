...
INC        = ./incs
SRC_DIR    = ./srcs
SRC_NAME   = main.c command.c error.c signal.c parsing.c parsing_sanitize.c parsing_utils.c redirect.c free.c pipe.c pids.c logfile_utils.c logfile.c command_utils.c prompt.c
